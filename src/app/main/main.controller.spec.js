(function() {
  ...
  describe('Controller: Main', function(){
    ...
    describe('Function: calculateColumnTotals(suites)', function () {
      it('should return summary data for each date', function () {
        var columnTotals = MainController.calculateColumnTotals(mockData);
        expect(columnTotals['2015-10-31T04:00:00.000Z'].totalSpecs).toBe(79);
        expect(columnTotals['2015-10-31T04:00:00.000Z'].totalPasses).toBe(77);
        expect(columnTotals['2015-10-31T04:00:00.000Z'].totalFails).toBe(2);
        expect(columnTotals['2015-10-31T04:00:00.000Z'].runs).toBe(2);
        expect(columnTotals['2015-10-31T04:00:00.000Z'].buildFails).toBe(2);
      });
    });
